...
dist/
├── chrome-extension/
└── WebSCADA_0.2.0_YYYYMMDD_HHMMSS.zip
```
...
WebSCADA v0.2.0 bağımsız bir Chrome MV3 extension olarak geliştirilmekte ve parent repository'den ayrılmış yapıdadır.
