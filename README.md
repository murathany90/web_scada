...
dist/
├── chrome-extension/
└── WebSCADA_0.3.0_YYYYMMDD_HHMMSS.zip
```
...
WebSCADA v0.3.0 bağımsız bir Chrome MV3 extension olarak geliştirilmekte ve parent repository'den ayrılmış yapıdadır.
