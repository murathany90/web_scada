...
dist/
├── chrome-extension/
└── WebSCADA_0.5.1_YYYYMMDD_HHMMSS.zip
```
...
WebSCADA v0.5.1 bağımsız bir Chrome MV3 extension olarak geliştirilmekte ve parent repository'den ayrılmış yapıdadır.
