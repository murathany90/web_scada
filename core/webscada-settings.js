((root, factory) => { const api = factory(); if (typeof module === 'object' && module.exports) module.exports = api; root.WebSCADASettings = api; })(typeof globalThis !== 'undefined' ? globalThis : this, () => {
  ...
  const DEFAULTS = Object.freeze({ autoRefreshEnabled: true, autoRefreshMinutes: 3, capacitySeason: 'winter', alarmNotificationsEnabled: true, alarmSoundEnabled: true, warningSound: 'warning_02_double_beep.wav', criticalSound: 'critical_01_dualtone.wav', alarmVolume: 100 });
