...
async function exportDiagnosticLogCsv() {
  ...
  const header = ['Zaman', 'Seviye', 'Kaynak', 'Olay', 'Mesaj', 'Trigger', 'RequestId', 'CycleId', 'Kural', 'Mod', 'Scope', 'Filtre', 'Varlik', 'Olcum', 'Batch', 'ToplamBatch', 'Cache', 'Network', 'Satir', 'VisibleMatched', 'VisibleTotal', 'Available', 'Missing', 'DataTimestamp', 'RecoveryCount', 'FailedBatchCount', 'FailedMeasurementCount', 'MergePreservedCount', 'FinalMissing', 'Evaluated', 'Active', 'New', 'Cleared', 'StorageBytes', 'SureMs', 'KuyrukMs', 'Sonuc', 'ErrorType', 'HttpStatus', 'AuthMode'];
  const rows = logs.map(e => [e.ts, e.level, e.subsystem, e.event, e.message, e.trigger, e.requestId, e.cycleId, e.ruleName || e.ruleId, e.mode, e.scopeSummary, e.filterSummary, e.entityCount, e.measurementCount, e.batchIndex, e.totalBatches, e.cacheCount, e.networkCount, e.returnedRows, e.visibleMatched, e.visibleTotal, e.available, e.missing, e.dataTimestamp, e.recoveryCount, e.failedBatchCount, e.failedMeasurementCount, e.mergePreservedCount, e.finalMissing, e.evaluated, e.active, e.new, e.cleared, e.storageBytes, e.durationMs, e.queueWaitMs, e.result, e.errorType, e.httpStatus, e.authMode]);
